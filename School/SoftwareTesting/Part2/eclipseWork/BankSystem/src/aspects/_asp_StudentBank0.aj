...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 8/*deleteUser*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 8/*deleteUser*/);
}
}
...
_cls_StudentBank0 _cls_inst = _cls_StudentBank0._get_cls_StudentBank0_inst();
_cls_inst._call(thisJoinPoint.getSignature().toString(), 6/*addUser*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 6/*addUser*/);
}
}
}