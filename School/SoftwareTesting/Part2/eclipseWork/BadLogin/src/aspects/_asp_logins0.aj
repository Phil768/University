...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 8/*goodLogin*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 8/*goodLogin*/);
}
}
...
_cls_inst._call(thisJoinPoint.getSignature().toString(), 10/*unlockAccount*/);
_cls_inst._call_all_filtered(thisJoinPoint.getSignature().toString(), 10/*unlockAccount*/);
}
}
}